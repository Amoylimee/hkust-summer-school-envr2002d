...
This repository is public. Record enough information to verify slide claims
without publishing private correspondence, personal contact details or
unapproved course files.

## Source policy

- Prefer primary and authoritative sources for non-trivial factual claims.
- Record private materials through neutral descriptions only.
- Record every final image's source, licence and slide purpose.
- Do not use generated or illustrative images as factual evidence.
- Keep `[Sources]` notes in `src/main.tex` for implemented slides.

## Implemented Part 1 slides

### Slide 1 — Lecture cover

- Course and presenter: ENVR2002D course context supplied by Jeremy.
- Year 4 PhD Candidate status and Division of Environment and Sustainability
  affiliation supplied by Jeremy.
- Lecture framing: approved two-part lecture plan.
- Visual: no image.

### Slide 2 — Two-part structure

- Timing: course guidance supplied privately by Jeremy; original messages are
  not committed.
...
### Slide 4 — Shipping came before research
...
- IMO conversion factors include 3.206 tonnes CO2 per tonne of diesel/gas oil,
  3.151 for light fuel oil and 3.114 for heavy fuel oil.
- Visible example: one tonne of marine diesel produces approximately 3.2
  tonnes of CO2.
...
- Bottom-up explanation simplified from the Fourth IMO GHG Study methodology:
  describe each ship, use movement data to understand its operation, estimate
...
- International Maritime Organization, *Fourth IMO Greenhouse Gas Study
  ...
  representing 2.89% of global anthropogenic CO2.
- Visible interpretation: science's first role is to provide evidence for
  policy discussion.
...
- Global Maritime Forum, *Annual Progress Report on Green Shipping Corridors
  ...
  initiatives facing a feasibility wall associated with the cost gap between
...
- Jeremy's earlier ENVR 4350 presentation contains the 2021 candidate-route
  ...
  with 52 two-way voyages, 29 ships, 23.3 average voyage days and 243,725
  tonnes of estimated annual fuel demand.
- Jeremy's op-ed, *Cherries to Carbon*, explains the interpretation: regular,
  long-haul traffic creates predictable fuel demand and meaningful potential
  for emissions reduction through cleaner fuels.
- Local source files:
...
- April 2025 presentation: Jeremy's personal account and presentation record
  supplied privately.
- Hong Kong Transport and Logistics Bureau, 17 November 2025: San Antonio Port
...
- Visual: Hong Kong Victoria Harbour night photograph by Raymond Yeung,
  published on Unsplash and free to use under the Unsplash License:
  https://unsplash.com/photos/nighttime-skyline-of-hong-kong-lit-up-cZ2PwQJ8Fpw

## Part 2 source links

- International Maritime Organization, quick guidance on fuel-consumption
  reporting and CO2 emission factors:
  https://gmn-phase-1.imo.org/wp-content/uploads/2019/02/PP2-Quick-guidance-printed-version.pdf
- UN Trade and Development, global merchant fleet data insight:
...
- UK Government, *COP 26 Clydebank Declaration for Green Shipping Corridors*:
...
- International Maritime Organization, *NextGEN Connect*:
  https://www.imo.org/en/ourwork/partnershipsprojects/pages/nextgen.aspx/
- Global Maritime Forum, *Annual Progress Report on Green Shipping Corridors
  2025*:
  https://globalmaritimeforum.org/report/annual-progress-report-on-green-shipping-corridors-2025/
- Global Maritime Forum, *Green corridors*:
  https://globalmaritimeforum.org/green-corridors/
- Hong Kong Transport and Logistics Bureau, 17 November 2025 Partner Port
  announcement:
  https://www.tlb.gov.hk/eng/psp/pressreleases/transport/2025/20251117c.html
- Hong Kong Transport and Logistics Bureau, 22 November 2025 blog:
  https://www.tlb.gov.hk/eng/blog/20251122.html

## Removed legacy provenance

The former HTML/PPTX source, outputs and illustrative assets have been
permanently removed from this repository. They are not approved sources for
the active Beamer deck.
