...
This document is the stable slide-by-slide plan. It defines what each slide needs to accomplish and what its right-side image should show. Visible copy may be refined during implementation, but the narrative job should not change without Jeremy's approval.
...
The default slide has:

- pure white background;
- short eyebrow label, title and one short paragraph on the left;
- one unique 8-bit / 16-bit pixel-art image on the right;
- simple sans-serif typography;
- no decorative content that does not advance the slide's point.

Every image brief below is part of the content specification, not optional decoration.

---

# Part 1 — How I ended up in shipping research

The narrative is chronological, then reflective: shipping background → intended industry career → accidental PhD decision → games and coding → present research → future ambition.

| Slide | Main takeaway / working title | Visible content | Right-side image brief |
|---|---|---|---|
| 1 | **How I ended up in shipping research** | A personal route through shipping, code and one unexpected decision. Jeremy Jiajing Chen, HKUST. | Identity-preserving pixel-art portrait of Jeremy, based on his real website photograph. Friendly and professional, not cartoonish. |
| 2 | **Shipping was part of my life before it became my research.** | Jeremy's grandfather and father worked at sea, so shipping felt personal before it became an academic subject. | Anonymous seafarer seen from behind on a working ship deck at sunrise. It must be labelled/treated as illustrative, never as a family photo. |
| 3 | **I learned the industry before I tried to change it.** | International shipping management led to shipping, logistics and environmental policy. | Pixel-art study desk with a shipping chart, port map, logistics notes and one textbook; the image should communicate learning the maritime system. |
| 4 | **After my Master's, I was going into industry.** | Jeremy accepted a supply-chain management job at Huawei. A PhD was not the plan. | Pixel-art corporate supply-chain scene: containers, route map and office screen. Avoid a large brand logo; the slide text can name Huawei. |
| 5 | **Then I saw one Research Assistant advertisement.** | Jeremy initially thought the temporary work might help fund his flight home. | Pixel-art laptop/email notice beside an airline ticket or suitcase. The image should make the accidental, practical motivation obvious without readable text. |
| 6 | **Ten minutes of persuasion. One day to decide.** | Prof. Alexis Lau encouraged Jeremy to stay; Jeremy decided to pursue a PhD the next day. | Pixel-art university office conversation with two figures, clock motif and daylight changing toward evening. No invented facial detail. |
| 7 | **Research fit the way my brain already liked to work.** | Transition from the external opportunity to the personal reason research felt natural. | Pixel-art close view of a person facing a computer with a complex but inviting problem on screen. Calm, reflective transition image. |
| 8 | **I liked computer games long before I liked research.** | Games created curiosity about computers and systems. | Pixel-art strategy-game setup with one monitor, keyboard and controller. Nostalgic and personal, not cyberpunk. |
| 9 | **Games led me to code. Code led me to research.** | Coding became the bridge from playing with systems to building and analysing them. | Pixel-art two-monitor desk: generic strategy map on one screen and simplified code lines on the other. No readable interface text. |
| 10 | **Research gave me the same satisfaction as a difficult game.** | A hard problem, repeated attempts, debugging and finally understanding the system. | Pixel-art debugging scene with failed output on one side of a monitor and a clean result emerging on the other. The image must show iteration, not merely “a person coding.” |
| 11 | **Shipping gave me the subject. Coding gave me the tools.** | Research brought Jeremy's shipping background and enjoyment of coding together. | Pixel-art container ship viewed from above with restrained data-route pixels flowing toward a computer terminal or analytical map. |
| 12 | **At HKUST, I use data to understand how maritime systems work.** | Large-scale shipping activity data helps reveal patterns that cannot be seen from shore. | Pixel-art container ship and port with AIS-like movement trails and spatial activity points. Keep the data layer intuitive rather than technical. |
| 13 | **My research moves from observation to useful evidence.** | Observe real activity, interpret it with code and translate the result for decisions. | One coherent pixel-art scene showing a ship/port observation becoming a simplified analytical result and then a policy briefing. Avoid three UI cards. |
| 14 | **A paper is not the final destination.** | The work matters when evidence enters a real conversation and supports action. | Pixel-art research paper or laptop on a meeting table overlooking a working port, with people discussing the result. |
| 15 | **After the PhD, I want to stay close to shipping and closer to implementation.** | Jeremy wants to connect research, public policy and industry action in lower-carbon shipping. | Hopeful but credible pixel-art port at sunrise with a container ship, shore-power equipment and restrained clean-energy cues. No science-fiction port. |

### Part 1 transition

Jeremy closes by connecting his route to the course:

> Research gave me a way to contribute to the industry that shaped me. After the break, I want to show what that contribution can look like when science meets maritime policy.

---

# Part 2 — How can science support maritime decarbonisation?

This section is a teaching argument, not a catalogue of Jeremy's papers:

1. science establishes the scale and location of the problem;
2. science compares possible pathways;
3. science tests whether attractive solutions are workable;
